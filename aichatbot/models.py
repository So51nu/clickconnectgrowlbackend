...
class ChatbotTenant(models.Model):
    ...
    # Tenant wise dynamic property API
    property_api_url = models.URLField(
        blank=True,
        null=True,
        help_text="Tenant specific property/project API URL",
    ...
    property_api_token = models.TextField(blank=True, null=True)
    property_api_key_header = models.CharField(
        max_length=100,
        blank=True,
        null=True,
    ...
    auto_sync_property_cache = models.BooleanField(
        default=True,
        help_text="If true, chatbot will save tenant API property data in JSON cache.",
    )
...
class ChatbotPropertyCache(models.Model):
    tenant = models.ForeignKey(
        ChatbotTenant,
        on_delete=models.CASCADE,
        related_name="property_cache",
    )
