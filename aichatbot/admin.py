...
from django.contrib import admin
from .models import ChatbotTenant, ChatbotPropertyCache, ChatSession, ChatMessage, ChatLead
...
class ChatbotTenantAdmin(admin.ModelAdmin):
    ...
    list_filter = ("is_active", "property_api_auth_type", "auto_sync_property_cache")
    readonly_fields = ("created_at",)
...
@admin.register(ChatbotPropertyCache)
class ChatbotPropertyCacheAdmin(admin.ModelAdmin):
    list_display = (
        "external_id",
        "title",
        "location",
