        ...
        return Response(
            {
                ...
                "user": {
                    "id": user.id,
                    "username": user.username,
                    "full_name": proper_full_name,
                    "email": user.email,
                    "phone": user_profile.phone or profile.phone,
                    "role": profile.role,
                    "is_phone_verified": profile.is_phone_verified,
                    "full_address": user_profile.full_address,
...
def user_profile_detail(request, user_id):
    ...
    login_profile = UserLoginProfile.objects.filter(user=user).first()
    ...
    return Response(
        {
            ...
            "data": {
                ...
                "full_name": full_name,
                "email": user.email or "",
                "phone": profile.phone or (login_profile.phone if login_profile else ""),
                "role": login_profile.role if login_profile else "",
                "full_address": profile.full_address or "",
...
def user_profile_update(request, user_id):
    ...
    full_name = data.get("full_name", profile.full_name or "")
    email = data.get("email", user.email or "")
    phone = data.get("phone", profile.phone or (login_profile.phone if login_profile else ""))
    ...
    profile.full_address = data.get("full_address", profile.full_address or "")
    profile.phone = phone
    profile.pincode = data.get("pincode", profile.pincode or "")
